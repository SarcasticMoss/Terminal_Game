...
while start == 2:
    prepare = (int(input('Then prepare yourself! Are you ready now? 1. Yes, or 2. No? ')))
if start == 1:
    ...
    print(int(input('Please select 1. Yes or 2. No: ')))
...
if shop == 1:
    ...
    if homebody == 3:
        ...
        if garden == 1:
            ...
            print('The sunflowers radiant yellow bring out a joy you hadnt realized you lost.')
